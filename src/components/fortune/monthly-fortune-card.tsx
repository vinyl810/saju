...
import type { MonthlyFortune } from '@/lib/saju/types';
...
export function MonthlyFortuneCard({ fortune }: MonthlyFortuneCardProps) {
    ...
    >
      <CardHeader className="pb-2">
        <CardTitle className="flex items-center gap-2 text-sm text-muted-foreground">
          <span className="font-serif text-lg text-foreground">{fortune.month}월</span>
          <TermTooltip termKey="월운">월운 (月運)</TermTooltip>
